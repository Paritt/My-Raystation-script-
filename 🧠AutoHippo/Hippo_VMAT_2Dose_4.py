...
def AddCostFunction():
    ...
    min_dose(Po, "zzPTV_uni", dose_level=DosePrescription*1.023,weigth=500)
    ...
    if ptv_boost in ListRoi:
        ...
        max_dose(Po, "zzHippo_tol", dose_level=14*100, weigth=300)
        ...
        max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.07, percent_volume=0.5, weigth=300)
        max_dose(Po, "zzHippo_tol", dose_level=14*100, weigth=300)
        uniform_constraint(Po, "zzPTV", stdv=1)
    ...
    max_dvh(Po, chiasm, dose_level=DosePrescription*1.03, percent_volume=0, weigth=5)
    max_dvh(Po, optic_l, dose_level=DosePrescription*1.03, percent_volume=0, weigth=5)
    max_dvh(Po, optic_r, dose_level=DosePrescription*1.03, percent_volume=0, weigth=5)
