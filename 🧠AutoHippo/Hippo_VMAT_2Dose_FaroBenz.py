...
def create_virtual():
    ...
    zBetween_Hippo.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", 
                                ExpressionA={ 'Operation': "Union", 'SourceRoiNames': [hippo_l], 
                                            'MarginSettings': { 'Type': "Contract", 'Superior': 0.5, 'Inferior': 0.5, 
                                                                'Anterior': 0.5, 'Posterior': 0.5, 
                                                                'Right': 0.5, 'Left': 2 } }, 
                                ExpressionB={ 'Operation': "Union", 'SourceRoiNames': [hippo_r], 
                                            'MarginSettings': { 'Type': "Expand", 'Superior': 0.5, 'Inferior': 0.5, 
                                                                'Anterior': 0.5, 'Posterior': 0.5, 
                                                                'Right': 2, 'Left': 0.5 } }, 
...
def multiple_optz(optz_number=1,opt=Po):
