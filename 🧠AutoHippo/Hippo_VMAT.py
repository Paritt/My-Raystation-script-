...
def Button_MatchRoi():
    ...
    combo_hippo_tol = lbMatch(Sub_root1, ListRoi, roi = hippo_tol, row_n = 1)
    combo_hippo_plus = lbMatch(Sub_root1, ListRoi, roi = hippo_plus, row_n = 2)
    combo_chiasm = lbMatch(Sub_root1, ListRoi, roi = chiasm, row_n = 3)
    combo_brainstem = lbMatch(Sub_root1, ListRoi, roi = brainstem, row_n = 4)
    combo_cord = lbMatch(Sub_root1, ListRoi, roi = cord, row_n = 5)
    combo_optic_r = lbMatch(Sub_root1, ListRoi, roi = optic_r, row_n = 6)
    combo_optic_l = lbMatch(Sub_root1, ListRoi, roi = optic_l, row_n = 7)
    combo_eye_r = lbMatch(Sub_root1, ListRoi, roi = eye_r, row_n = 8)
    combo_eye_l = lbMatch(Sub_root1, ListRoi, roi = eye_l, row_n = 9)
    combo_lg_r = lbMatch(Sub_root1, ListRoi, roi = lg_r, row_n = 10)
    combo_lg_l = lbMatch(Sub_root1, ListRoi, roi = lg_l, row_n = 11)
    combo_len_r = lbMatch(Sub_root1, ListRoi, roi = len_r, row_n = 12)
    combo_len_l = lbMatch(Sub_root1, ListRoi, roi = len_l, row_n = 13)
    combo_brain = lbMatch(Sub_root1, ListRoi, roi = brain, row_n = 14)
    combo_body = lbMatch(Sub_root1, ListRoi, roi = body, row_n = 15)
    ...
    buttCancelSub1.grid(column=0,row=15,pady=15)
    ...
    buttApplySub1.grid(column=1,row=15,pady=15)
...
lbMatchRoi.config(width=27, height =2)
ListRoi = [r.Name for r in patient.Cases[0].PatientModel.RegionsOfInterest]
ListRoiOpt = [ptv, hippo_tol, hippo_plus, chiasm, brainstem, cord, optic_r, optic_l, eye_r, eye_l, lg_r, lg_l, len_r, len_l, brain, body]
print(ListRoi)
    ...
    zPTV.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", 
                            ExpressionA={ 'Operation': "Union", 'SourceRoiNames': [ptv], 
                                        'MarginSettings': { 'Type': "Expand", 'Superior': 0, 'Inferior': 0, 
                                                            ...
                                                            'Right': 0, 'Left': 0 } }, 
                            ExpressionB={ 'Operation': "Union", 'SourceRoiNames': [hippo_plus], 
    ...
    zBS_PTV.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", 
                                ExpressionA={ 'Operation': "Union", 'SourceRoiNames': [brainstem], 
                                            'MarginSettings': { 'Type': "Expand", 'Superior': 0, 'Inferior': 0, 
                                                                'Anterior': 0, 'Posterior': 0, 
                                                                'Right': 0, 'Left': 0 } }, 
                                ExpressionB={ 'Operation': "Union", 'SourceRoiNames': [hippo_tol], 
...
def addPlan():
    ...
    Add_Beam1 = beam_set.CreateArcBeam(ArcStopGantryAngle=179, ArcRotationDirection="Clockwise", 
                            ...
                            CouchPitchAngle=0, CouchRollAngle=0, CollimatorAngle=315)
    ...
    Add_Beam2 = beam_set.CreateArcBeam(ArcStopGantryAngle=181, ArcRotationDirection="CounterClockwise", 
                            ...
                            CouchPitchAngle=0, CouchRollAngle=0, CollimatorAngle=45)
...
def AddCostFunction():
    ...
    min_dvh(Po,"zzBS_PTV", dose_level=DosePrescription*1.005, percent_volume=98.5, weigth=210)
    max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.05, percent_volume=0.1, weigth=300)
    max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.03, percent_volume=1.5, weigth=190)
    max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.02, percent_volume=12, weigth=175)
    max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.07, percent_volume=0, weigth=400)
    min_dvh(Po,"zzPTV", dose_level=DosePrescription*1.01, percent_volume=99.5, weigth=260)
    min_dvh(Po,"zzPTV", dose_level=DosePrescription*1.00, percent_volume=99.7, weigth=280)
    min_dvh(Po,"zzPTV", dose_level=DosePrescription*0.95, percent_volume=100, weigth=200)
    max_eud(Po, "zzPTV", dose_level=DosePrescription*1.018, eud_parameter=40, weigth=115)
    min_dvh(Po,"zzPTV_uni", dose_level=DosePrescription*1.023, percent_volume=100, weigth=200)
    uniform_constraint(Po, "zzPTV_uni", stdv=1)
    max_dvh(Po,"zzRing", dose_level=DosePrescription*0.94, percent_volume=0, weigth=350)
    max_eud(Po, "zzFace", dose_level=10*100, eud_parameter=1, weigth=1)
    max_dvh(Po, hippo_plus, dose_level=20*100, percent_volume=0, weigth=1)
    max_dvh(Po, hippo_plus, dose_level=15*100, percent_volume=50, weigth=1)
    max_dvh(Po, hippo_plus, dose_level=10*100, percent_volume=70, weigth=1)
    max_dvh(Po, hippo_plus, dose_level=8*100, percent_volume=90, weigth=1)
    max_eud(Po, hippo_plus, dose_level=15*100, eud_parameter=1, weigth=1)
    max_dvh(Po, hippo_tol, dose_level=5*100, percent_volume=99, weigth=1)
    max_dvh(Po, hippo_tol, dose_level=10*100, percent_volume=0, weigth=1)
    max_dose_constraint(Po, hippo_tol, dose_level=15*100)
    max_eud(Po, lg_l, dose_level=7*100, eud_parameter=1, weigth=1)
    max_dvh(Po, lg_l, dose_level=10*100, percent_volume=0, weigth=1)
    max_eud(Po, lg_r, dose_level=7*100, eud_parameter=1, weigth=1)
    max_dvh(Po, lg_r, dose_level=10*100, percent_volume=0, weigth=1)
    max_dvh(Po, len_l, dose_level=3*100, percent_volume=0, weigth=1)
    max_dvh(Po, len_r, dose_level=3*100, percent_volume=0, weigth=1)
    max_dvh(Po, chiasm, dose_level=DosePrescription*0.95, percent_volume=0, weigth=5)
    max_dvh(Po, optic_l, dose_level=DosePrescription*0.95, percent_volume=0, weigth=5)
    max_dvh(Po, optic_r, dose_level=DosePrescription*0.95, percent_volume=0, weigth=5)
    max_dvh(Po, cord, dose_level=30*100, percent_volume=0, weigth=1)
    max_eud(Po, eye_l, dose_level=5*100, eud_parameter=1, weigth=1)
    max_eud(Po, eye_r, dose_level=5*100, eud_parameter=1, weigth=1)
...
def Button_Next():
    ...
    try:
        ...
        try:
            ...
            ############################################################
            create_contour_from_dose(plan.TreatmentCourse.TotalDose, 105, "zzDose_105%")
            max_dvh(Po, "zzDose_105%", dose_level=DosePrescription*1.05, percent_volume=0.5, weigth=100)
            create_plus_dose(plan.TreatmentCourse.TotalDose, DosePrescription/100, f"zz+{DosePrescription/100}", X=ptv)
