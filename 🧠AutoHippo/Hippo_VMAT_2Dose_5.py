...
def AddCostFunction():
    print("Start adding cost function")
    ...
    min_dvh(Po,"zzBS_PTV", dose_level=DosePrescription*1.005, percent_volume=97.5, weigth=210)
    max_dvh(Po,"zzBS_PTV", dose_level=DosePrescription*1.045, percent_volume=0, weigth=500)
    ...
    min_dose(Po, "zzPTV_uni", dose_level=DosePrescription*1.025,weigth=700)
    ...
    if ptv_boost in ListRoi:
        ...
        max_dose(Po, "zzHippo_tol", dose_level=15*100, weigth=1400)
        max_dose(Po, hippo_l, dose_level=15*100, weigth=1400)
        max_dose(Po, hippo_r, dose_level=15*100, weigth=1400)
        max_dvh(Po,"zzRing_boost", dose_level=DosePrescription_boost*0.95, percent_volume=0, weigth=200)
        uniform_constraint(Po, "zzPTV", stdv=1.5)
    else:
        max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.05, percent_volume=1, weigth=300)
        max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.07, percent_volume=0.5, weigth=300)
        max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.1, percent_volume=0, weigth=300)
        max_dose(Po, "zzHippo_tol", dose_level=14*100, weigth=1400)
        max_dose(Po, hippo_l, dose_level=15*100, weigth=1400)
        max_dose(Po, hippo_r, dose_level=15*100, weigth=1400)
        uniform_constraint(Po, "zzPTV", stdv=1.5)
    ...
    max_dvh(Po, "zzHippo_plus", dose_level=20*100, percent_volume=0, weigth=1)
    max_dvh(Po, "zzHippo_plus", dose_level=15*100, percent_volume=50, weigth=1)
    max_dvh(Po, "zzHippo_plus", dose_level=10*100, percent_volume=70, weigth=1)
    max_dvh(Po, "zzHippo_plus", dose_level=8*100, percent_volume=90, weigth=1)
    max_eud(Po, "zzHippo_plus", dose_level=13*100, eud_parameter=1, weigth=1)
    max_dvh(Po, "zzHippo_tol", dose_level=5*100, percent_volume=90, weigth=1)
    max_dvh(Po, "zzHippo_tol", dose_level=9*100, percent_volume=0, weigth=1)
    max_dvh(Po, "zzHippo_contract", dose_level=9*100, percent_volume=30, weigth=100)
    ...
    max_dvh(Po, len_l, dose_level=5*100, percent_volume=0, weigth=1)
    max_dvh(Po, len_r, dose_level=5*100, percent_volume=0, weigth=1)
    max_dvh(Po, chiasm, dose_level=DosePrescription*1.02, percent_volume=0, weigth=10)
    max_dvh(Po, optic_l, dose_level=DosePrescription*1.02, percent_volume=0, weigth=10)
    max_dvh(Po, optic_r, dose_level=DosePrescription*1.02, percent_volume=0, weigth=10)
    max_dvh(Po, brainstem, dose_level=DosePrescription*1.02, percent_volume=0, weigth=10)
    max_dvh(Po, cord, dose_level=30*100, percent_volume=0, weigth=1)
    max_eud(Po, eye_l, dose_level=7*100, eud_parameter=1, weigth=1)
    max_eud(Po, eye_r, dose_level=7*100, eud_parameter=1, weigth=1)
...
def Button_Next():
    ...
    try:
        ...
        try:
            ...
            max_eud(Po, "zzHippo_tol",dose_level=9*100, eud_parameter=20, weigth=10)
            if ptv_boost in ListRoi:
