...
lbMatchRoi.config(width=27, height =2)
ListRoi = [r.Name for r in patient.Cases[0].PatientModel.RegionsOfInterest]
ListRoiOpt = [ptv, hippo_r, hippo_l, chiasm, brainstem, cord, optic_r, optic_l, eye_r, eye_l, lg_r, lg_l, len_r, len_l, brain, body]
print(ListRoi)
...
def AddCostFunction():
    ...
    min_dose(Po, "zzPTV_uni", dose_level=DosePrescription*1.023,weigth=200)
    ...
    if ptv_boost in ListRoi:
        ...
        max_dose(Po, "zzHippo_tol", dose_level=15*100, weigth=300)
        max_dvh(Po,"zzRing_boost", dose_level=DosePrescription_boost*0.95, percent_volume=0, weigth=200)
        uniform_constraint(Po, "zzPTV_uni", stdv=0.5)
    else:
        max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.05, percent_volume=1, weigth=300)
        max_dvh(Po,"zzPTV", dose_level=DosePrescription*1.07, percent_volume=0.5, weigth=300)
        max_dose(Po, "zzHippo_tol", dose_level=15*100, weigth=300)
    ...
    max_eud(Po, "zzHippo_plus", dose_level=15*100, eud_parameter=1, weigth=1)
    max_dvh(Po, "zzHippo_tol", dose_level=5*100, percent_volume=99, weigth=1)
    max_dvh(Po, "zzHippo_tol", dose_level=10*100, percent_volume=0, weigth=1)
