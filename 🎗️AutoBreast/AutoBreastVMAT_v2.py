...
def Button_MatchRoi():
    ...
    combo_thyroid = lbMatch(Sub_root1, ListRoi, roi = "Thyroid Gland", row_n = 9)
...
lbMatchRoi.config(width=27, height =2)
ListRoi = [r.Name for r in patient.Cases[0].PatientModel.RegionsOfInterest]
ListRoiOpt = ["PTV","CTV","Lung Lt","Lung Rt","Breast Rt","Heart","Great Vessels","Liver","Stomach","Esophagus","Thyroid Gland","BODY","zArm"]
print(ListRoi)
