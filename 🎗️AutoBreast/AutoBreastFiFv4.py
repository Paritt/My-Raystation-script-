...
def create_PTV_eval(PTV_name="PTV",Body_name="BODY"):
	zPTV = case.PatientModel.CreateRoi(Name='zPTV_eval', Color="Red", Type="Ptv", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
	zPTV.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Union", 'SourceRoiNames': [f"{PTV_name}"], 'MarginSettings': { 'Type': "Expand", 'Superior': 0, 'Inferior': 0, 'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 } }, ExpressionB={ 'Operation': "Union", 'SourceRoiNames': [f"{Body_name}"], 'MarginSettings': { 'Type': "Contract", 'Superior': 0.3, 'Inferior': 0.3, 'Anterior': 0.3, 'Posterior': 0.3, 'Right': 0.3, 'Left': 0.3 } }, ResultOperation="Intersection", ResultMarginSettings={ 'Type': "Expand", 'Superior': 0, 'Inferior': 0, 'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 })
...
def FiF(case, plan, beamset, subMedTang="3",subLatTang="4",initial_MU = 10,step_MU=2, accept_hot=1.05, PTV_name="PTV", Body_name="BODY", n=0, symmetry = True):
	...
	create_contour_from_dose(plan.TreatmentCourse.TotalDose, 105, case, beamset, n=n)
	
	
	if symmetry == True:
		beamset.Beams[subMedTang].SetTreatOrProtectRoi(RoiName = 'zPTV_eval')
		beamset.Beams[subMedTang].SetTreatOrProtectRoi(RoiName = f'z Dose_105%_{n}')
		beamset.Beams[subMedTang].SetTreatAndProtectMarginsForBeam(TopMargin=0.0,BottomMargin=0.0,LeftMargin=0.0,RightMargin=0.0,Roi= 'zPTV_eval')
		beamset.Beams[subMedTang].SetTreatAndProtectMarginsForBeam(TopMargin=0.0,BottomMargin=0.0,LeftMargin=0.0,RightMargin=0.0,Roi= f"z Dose_105%_{n}")
		
		beamset.Beams[subLatTang].SetTreatOrProtectRoi(RoiName = 'zPTV_eval')
		beamset.Beams[subLatTang].SetTreatOrProtectRoi(RoiName = f'z Dose_105%_{n}')
		beamset.Beams[subLatTang].SetTreatAndProtectMarginsForBeam(TopMargin=0.0,BottomMargin=0.0,LeftMargin=0.0,RightMargin=0.0,Roi= 'zPTV_eval')
		beamset.Beams[subLatTang].SetTreatAndProtectMarginsForBeam(TopMargin=0.0,BottomMargin=0.0,LeftMargin=0.0,RightMargin=0.0,Roi= f"z Dose_105%_{n}")
...
def Halving_breast(beam_set=beamset, PTV = "PTV", Body_name= "Body"):
	create_contour_from_dose(plan.TreatmentCourse.TotalDose, 30, case, beamset, n=999)
	...
	roi2.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Intersection", 'SourceRoiNames': ["z Dose_30%_999",f"{Body_name}"], 'MarginSettings': { 'Type': "Expand", 'Superior': 0, 'Inferior': 0, 'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 } }, ExpressionB={ 'Operation': "Union", 'SourceRoiNames': ["zLatHalf"], 'MarginSettings': { 'Type': "Expand", 'Superior': 0, 'Inferior': 0, 'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 } }, ResultOperation="Subtraction", ResultMarginSettings={ 'Type': "Expand", 'Superior': 0, 'Inferior': 0, 'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 })
	beam_set.DeleteBeam(BeamName="3")
	case.PatientModel.RegionsOfInterest["z Dose_30%_999"].DeleteRoi()
...
def Start():
	...
	create_PTV_eval(PTV_name=PTV_name,Body_name=Body_name)
	beam_set.ScaleToDoseGoal(DspName=None, RoiName="zPTV50_eval", DoseValue=5000, DoseVolume=95, PrescriptionType="DoseAtVolume", LockedBeamNames=None, EvaluateOptimizationFunctionsAfterScaling=False, IncludeBackgroundDose=False
