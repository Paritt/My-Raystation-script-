...
def Button_MatchRoi():
    ...
    combo_RtBreast = lbMatch(Sub_root1, ListRoi, roi = rt_breast, row_n = 4)
...
lbMatchRoi.config(width=27, height =2)
ListRoi = [r.Name for r in patient.Cases[0].PatientModel.RegionsOfInterest]
ListRoiOpt = [ptv,ctv,lt_lung,rt_lung,rt_breast,heart,thyroid,eso,body,arm]
print(ListRoi)
...
def addPlan():
    ...
    beam_set.UpdateDoseGrid(Corner={'x': dose_grid.Corner.x, 'y': dose_grid.Corner.y, 'z': dose_grid.Corner.z},
