...
comboRoiPre.grid(column=1,row=5)
...
comboPhotonE.grid(column=1,row=7)
...
#Match CTV 54
 ...
 if "BODY" in ListRoi:
  ...
  lbMatchRoiOpt9.grid(column=1 , row=8)
...
buttCancel.grid(column=0,row=9,padx=10,pady=25)
...
#optimized zr Organ-PTV54
 with CompositeAction('Add optimization function'):
   AddCostFunc10 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr Organ-PTV54") 
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc11 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName="zr Organ-PTV54")
...
#optimized BODY   
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc23 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr RingPTV")
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc24 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName="zr RingPTV")
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc25 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName="zr PTV 50.4+Organ")
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc26 = Po.AddOptimizationFunction(FunctionType="MinDvh", RoiName="zr PTV 50.4+Organ")
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc27 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr Ant")
 ...
 with CompositeAction('Add optimization function zr Organ-PTV54'):
   AddCostFunc28 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr Organ-PTV54")
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc29 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName="zr Organ-PTV54")
 ...
 with CompositeAction('Add optimization function zr Bladder'):
   AddCostFunc30 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr Bladder")
 ...
 with CompositeAction('Add optimization function zr PTV50.4'):
   AddCostFunc31 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr PTV50.4")
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc32 = Po.AddOptimizationFunction(FunctionType="MaxDvh", RoiName="zr PTV50.4")
 ...
 with CompositeAction('Add optimization function zr Perineum'):
   AddCostFunc33 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr Perineum")
...
def Button_Next():
 try:
  ...
  try:
   ...
   #Creat virtual organ : zr RingPTV
   ...
   VirtualRing.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Union", 
              ...
              'Right': 0, 'Left': 0 })
     #Creat virtual organ : zr Bladder
   ...
   VirtualBladder.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Union", 'SourceRoiNames': [Opt5], 
     ...
     #Creat virtual organ : zr PTV 50.4+Organ
   ...
   VirtualPtv504Organ.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Union", 
            ...
            'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 })
     #Creat virtual organ : zr PTV 54+Organ
   VirtualPtv54Organ = case.PatientModel.CreateRoi(Name="zr PTV 54+Organ", Color="White", Type="Control", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
   VirtualPtv54Organ.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Union", 
            ...
            ResultOperation="Intersection", ResultMarginSettings={ 'Type': "Expand", 'Superior': 0, 'Inferior': 0, 
            'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 })
     #Creat virtual organ : zr Organ-PTV54
   VirtualOrganSub54 = case.PatientModel.CreateRoi(Name="zr Organ-PTV54", Color="SaddleBrown", Type="Control", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
   VirtualOrganSub54.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Union",
            ...
            'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 })
     #Creat virtual organ : zr PTV50.4
   ...
   VirtualPTV504.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Union",
            ...
            ResultMarginSettings={ 'Type': "Expand", 'Superior': 0, 'Inferior': 0, 
            'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 })  
     #Creat virtual organ : zr Perineum
   VirtualPTV504 = case.PatientModel.CreateRoi(Name="zr Perineum", Color="SaddleBrown", Type="Control", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
   VirtualPTV504.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Union",
   ...
   for o in range(1,6):
    ...
    MaxVirtualOrganSub54 = plan.TreatmentCourse.TotalDose.GetDoseAtRelativeVolumes(RoiName="zr Organ-PTV54", RelativeVolumes=[0])
   ...
   ## Check Dose 105% area
   dose105 = plan.TreatmentCourse.TotalDose.GetRelativeVolumeAtDoseValues(RoiName="zr PTV50.4", DoseValues=[int(DosePrescription1)*1.05])
   if dose105 > 0.05:
   	## Covert 105% to contour
   	create_contour_from_dose(plan.TreatmentCourse.TotalDose, 105)
   	add_105constrain("zr Dose_105%",DosePrescription1)
   	case.PatientModel.RegionsOfInterest['zr Dose_105%'].CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", 
   			ExpressionA={ 'Operation': "Union", 'SourceRoiNames': ["zr Dose_105%"], 
   			'MarginSettings': { 'Type': "Expand", 'Superior': 0, 
   			'Inferior': 0, 'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 } }, 
...
buttNext.grid(column=1,row=9,padx=10,pady=25)
