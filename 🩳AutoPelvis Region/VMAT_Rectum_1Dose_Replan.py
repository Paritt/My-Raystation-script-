...
def Button_MatchRoi():
 ...
 #Match Bladder
 lbMatchRoi5 = Label(Sub_root1, text= 'Bladder')
 ...
 #Match Perineum
 lbMatchRoi10 = Label(Sub_root1, text= 'Perineum')
 lbMatchRoi10.grid(column=0 , row=7)
 lbMatchRoi10.config(width=15, height =2)
 if "Perineum" in ListRoi:
  lbMatchRoiOpt10 = Label(Sub_root1, text= 'Matched')
  lbMatchRoiOpt10.grid(column=1 , row=7)
  lbMatchRoiOpt10.config(width=27, height =2)
 else:
  combo_Opt10 = StringVar()
  comboOpt10 = ttk.Combobox(Sub_root1, values = ListRoi, textvariable= combo_Opt10)
  comboOpt10.grid(column=1,row=7)
  comboOpt10.config(width=27, height =20)  
 #Match Body
 lbMatchRoi9 = Label(Sub_root1, text= 'BODY')
 lbMatchRoi9.grid(column=0 , row=9)
 lbMatchRoi9.config(width=15, height =2)
 if "BODY" in ListRoi:
  lbMatchRoiOpt9 = Label(Sub_root1, text= 'Matched')
  lbMatchRoiOpt9.grid(column=1 , row=9)
  lbMatchRoiOpt9.config(width=27, height =2)
 else:
  combo_Opt9 = StringVar()
  comboOpt9 = ttk.Combobox(Sub_root1, values = ListRoi, textvariable= combo_Opt9)
  comboOpt9.grid(column=1,row=9)
  comboOpt9.config(width=27, height =20)
...
ListRoi = [r.Name for r in patient.Cases[0].PatientModel.RegionsOfInterest]
ListRoiOpt = ["PTV 50.4","CTV 50.4","Bladder","Sigmoid","Small bowel","BODY","Perineum"]
print(ListRoi)
...
def AddCostFucn():
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc1 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName=Opt1) #PTV 50.4
   Po.Objective.ConstituentFunctions[1].DoseFunctionParameters.DoseLevel = int(DosePrescription*1.03778)
   Po.Objective.ConstituentFunctions[1].DoseFunctionParameters.PercentVolume = 98
   Po.Objective.ConstituentFunctions[1].DoseFunctionParameters.Weight = 10
 with CompositeAction('Add optimization function'):
...
#optimized Bladder
 with CompositeAction('Add optimization function Bladder'):
   AddCostFunc3 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName=Opt5) 
   Po.Objective.ConstituentFunctions[3].DoseFunctionParameters.DoseLevel = int(DosePrescription*1.02778)
   Po.Objective.ConstituentFunctions[3].DoseFunctionParameters.PercentVolume = 98
   Po.Objective.ConstituentFunctions[3].DoseFunctionParameters.Weight = 10
 with CompositeAction('Add optimization function Bladder'):
   AddCostFunc4 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt5) 
   Po.Objective.ConstituentFunctions[4].DoseFunctionParameters.HighDoseLevel = int(DosePrescription)
   Po.Objective.ConstituentFunctions[4].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.77778)
   Po.Objective.ConstituentFunctions[4].DoseFunctionParameters.LowDoseDistance = 1.5
   Po.Objective.ConstituentFunctions[4].DoseFunctionParameters.Weight = 10  
 with CompositeAction('Add optimization function Bladder'):
   AddCostFunc5 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt5) 
   Po.Objective.ConstituentFunctions[5].DoseFunctionParameters.HighDoseLevel = int(DosePrescription)
   Po.Objective.ConstituentFunctions[5].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.44445)
   Po.Objective.ConstituentFunctions[5].DoseFunctionParameters.LowDoseDistance = 2.5
   Po.Objective.ConstituentFunctions[5].DoseFunctionParameters.Weight = 20 
 with CompositeAction('Add optimization function Bladder'):
   AddCostFunc6 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt5)
   Po.Objective.ConstituentFunctions[6].DoseFunctionParameters.HighDoseLevel = int(DosePrescription)
   Po.Objective.ConstituentFunctions[6].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.26667)
   Po.Objective.ConstituentFunctions[6].DoseFunctionParameters.LowDoseDistance = 6
   Po.Objective.ConstituentFunctions[6].DoseFunctionParameters.Weight = 10
#optimized Sigmoid
 with CompositeAction('Add optimization function'):
   AddCostFunc7 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName=Opt6)
   Po.Objective.ConstituentFunctions[7].DoseFunctionParameters.DoseLevel = int(5400*1.035)
   Po.Objective.ConstituentFunctions[7].DoseFunctionParameters.PercentVolume = 98
   Po.Objective.ConstituentFunctions[7].DoseFunctionParameters.Weight = 50 
 with CompositeAction('Add optimization function'):
   AddCostFunc8 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt6)
   Po.Objective.ConstituentFunctions[8].DoseFunctionParameters.HighDoseLevel = int(5400)
   Po.Objective.ConstituentFunctions[8].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.77778)
   Po.Objective.ConstituentFunctions[8].DoseFunctionParameters.LowDoseDistance = 1.5
   Po.Objective.ConstituentFunctions[8].DoseFunctionParameters.Weight = 10
   Po.Objective.ConstituentFunctions[8].DoseFunctionParameters.AdaptToTargetDoseLevels = True   
 with CompositeAction('Add optimization function'):
   AddCostFunc9 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt6)
   Po.Objective.ConstituentFunctions[9].DoseFunctionParameters.HighDoseLevel = int(DosePrescription)
   Po.Objective.ConstituentFunctions[9].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.5)
   Po.Objective.ConstituentFunctions[9].DoseFunctionParameters.LowDoseDistance = 2.0
   Po.Objective.ConstituentFunctions[9].DoseFunctionParameters.Weight = 10
   Po.Objective.ConstituentFunctions[9].DoseFunctionParameters.AdaptToTargetDoseLevels = True
#optimized Small bowel
 with CompositeAction('Add optimization function'):
   AddCostFunc10 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt7)
   Po.Objective.ConstituentFunctions[10].DoseFunctionParameters.HighDoseLevel = int(DosePrescription)
   Po.Objective.ConstituentFunctions[10].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.77778)
   Po.Objective.ConstituentFunctions[10].DoseFunctionParameters.LowDoseDistance = 1.0
   Po.Objective.ConstituentFunctions[10].DoseFunctionParameters.Weight = 10
   Po.Objective.ConstituentFunctions[10].DoseFunctionParameters.AdaptToTargetDoseLevels = True  
 with CompositeAction('Add optimization function'):
   AddCostFunc11 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt7)
   Po.Objective.ConstituentFunctions[11].DoseFunctionParameters.HighDoseLevel = int(DosePrescription)
   Po.Objective.ConstituentFunctions[11].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.5)
   Po.Objective.ConstituentFunctions[11].DoseFunctionParameters.LowDoseDistance = 2.5
   Po.Objective.ConstituentFunctions[11].DoseFunctionParameters.Weight = 20
   Po.Objective.ConstituentFunctions[11].DoseFunctionParameters.AdaptToTargetDoseLevels = True     
 with CompositeAction('Add optimization function'):
   AddCostFunc12 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt7)
   Po.Objective.ConstituentFunctions[12].DoseFunctionParameters.HighDoseLevel = int(DosePrescription)
   Po.Objective.ConstituentFunctions[12].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.26667)
   Po.Objective.ConstituentFunctions[12].DoseFunctionParameters.LowDoseDistance = 3.5
   Po.Objective.ConstituentFunctions[12].DoseFunctionParameters.Weight = 20
   Po.Objective.ConstituentFunctions[12].DoseFunctionParameters.AdaptToTargetDoseLevels = True
 with CompositeAction('Add optimization function'):
   AddCostFunc13 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName=Opt7)
   Po.Objective.ConstituentFunctions[13].DoseFunctionParameters.DoseLevel = int(DosePrescription*1.035)
   Po.Objective.ConstituentFunctions[13].DoseFunctionParameters.PercentVolume = 98
   Po.Objective.ConstituentFunctions[13].DoseFunctionParameters.Weight = 50 
#optimized BODY   
 with CompositeAction('Add optimization function'): 
   AddCostFunc14 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName=Opt9)
   Po.Objective.ConstituentFunctions[14].DoseFunctionParameters.DoseLevel = int(DosePrescription*1.05556)
   Po.Objective.ConstituentFunctions[14].DoseFunctionParameters.PercentVolume = 98
   Po.Objective.ConstituentFunctions[14].DoseFunctionParameters.Weight = 300 
 with CompositeAction('Add optimization function'): 
   AddCostFunc15 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt9)
   Po.Objective.ConstituentFunctions[15].DoseFunctionParameters.HighDoseLevel = int(DosePrescription*1.005)
   Po.Objective.ConstituentFunctions[15].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.7937)
   Po.Objective.ConstituentFunctions[15].DoseFunctionParameters.LowDoseDistance = 1.5
 ...
 with CompositeAction('Add optimization function'):
   AddCostFunc16 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt9)
   Po.Objective.ConstituentFunctions[16].DoseFunctionParameters.HighDoseLevel = int(DosePrescription*1.005)
   Po.Objective.ConstituentFunctions[16].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.5)
   Po.Objective.ConstituentFunctions[16].DoseFunctionParameters.LowDoseDistance = 2
   Po.Objective.ConstituentFunctions[16].DoseFunctionParameters.AdaptToTargetDoseLevels = True
 with CompositeAction('Add optimization function'):
   AddCostFunc17 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt9)
   Po.Objective.ConstituentFunctions[17].DoseFunctionParameters.HighDoseLevel = int(DosePrescription*1.005)
   Po.Objective.ConstituentFunctions[17].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.9)
   Po.Objective.ConstituentFunctions[17].DoseFunctionParameters.LowDoseDistance = 0.5
   Po.Objective.ConstituentFunctions[17].DoseFunctionParameters.Weight = 30
   Po.Objective.ConstituentFunctions[17].DoseFunctionParameters.AdaptToTargetDoseLevels = True
 with CompositeAction('Add optimization function'):
   AddCostFunc18 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr RingPTV")
   Po.Objective.ConstituentFunctions[18].DoseFunctionParameters.HighDoseLevel = int(DosePrescription*0.99)
   Po.Objective.ConstituentFunctions[18].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.77778)
   Po.Objective.ConstituentFunctions[18].DoseFunctionParameters.LowDoseDistance = 0.5
   Po.Objective.ConstituentFunctions[18].DoseFunctionParameters.Weight = 10
   Po.Objective.ConstituentFunctions[18].DoseFunctionParameters.AdaptToTargetDoseLevels = True
 with CompositeAction('Add optimization function'):
   AddCostFunc19 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName="zr RingPTV")
   Po.Objective.ConstituentFunctions[19].DoseFunctionParameters.DoseLevel = int(DosePrescription*0.98889)
   Po.Objective.ConstituentFunctions[19].DoseFunctionParameters.PercentVolume = 98
   Po.Objective.ConstituentFunctions[19].DoseFunctionParameters.Weight = 200
 with CompositeAction('Add optimization function'):
   AddCostFunc20 = Po.AddOptimizationFunction(FunctionType="MaxDose", RoiName="zr PTV 50.4+Organ")
   Po.Objective.ConstituentFunctions[20].DoseFunctionParameters.DoseLevel = int(DosePrescription*1.04)
   Po.Objective.ConstituentFunctions[20].DoseFunctionParameters.PercentVolume = 98
   Po.Objective.ConstituentFunctions[20].DoseFunctionParameters.Weight = 100
 with CompositeAction('Add optimization function'):
   AddCostFunc21 = Po.AddOptimizationFunction(FunctionType="MinDvh", RoiName="zr PTV 50.4+Organ")
   Po.Objective.ConstituentFunctions[21].DoseFunctionParameters.DoseLevel = int(DosePrescription*1.00445)
   Po.Objective.ConstituentFunctions[21].DoseFunctionParameters.PercentVolume = 95
   Po.Objective.ConstituentFunctions[21].DoseFunctionParameters.Weight = 300
 with CompositeAction('Add optimization function'):
   AddCostFunc22 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr Ant")
   Po.Objective.ConstituentFunctions[22].DoseFunctionParameters.HighDoseLevel = int(DosePrescription*0.82223)
   Po.Objective.ConstituentFunctions[22].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.27778)
   Po.Objective.ConstituentFunctions[22].DoseFunctionParameters.LowDoseDistance = 2.0
   Po.Objective.ConstituentFunctions[22].DoseFunctionParameters.Weight = 10
 with CompositeAction('Add optimization function z Bladder'):
   AddCostFunc23 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr Bladder")
   Po.Objective.ConstituentFunctions[23].DoseFunctionParameters.HighDoseLevel = int(DosePrescription*0.62222)
   Po.Objective.ConstituentFunctions[23].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.4)
   Po.Objective.ConstituentFunctions[23].DoseFunctionParameters.LowDoseDistance = 1
   Po.Objective.ConstituentFunctions[23].DoseFunctionParameters.Weight = 20
 with CompositeAction('Add optimization function z PTV50.4'):
   AddCostFunc24 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName=Opt1)
   Po.Objective.ConstituentFunctions[24].DoseFunctionParameters.HighDoseLevel = int(5375)
   Po.Objective.ConstituentFunctions[24].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*1.035)
   Po.Objective.ConstituentFunctions[24].DoseFunctionParameters.LowDoseDistance = 0.3
   Po.Objective.ConstituentFunctions[24].DoseFunctionParameters.Weight = 10
 with CompositeAction('Add optimization function'):
   AddCostFunc25 = Po.AddOptimizationFunction(FunctionType="MaxDvh", RoiName=Opt1)
   Po.Objective.ConstituentFunctions[25].DoseFunctionParameters.DoseLevel = int(DosePrescription*1.04)
   Po.Objective.ConstituentFunctions[25].DoseFunctionParameters.PercentVolume = 1
   Po.Objective.ConstituentFunctions[25].DoseFunctionParameters.Weight = 300 
 with CompositeAction('Add optimization function z Perineum'):
   AddCostFunc26 = Po.AddOptimizationFunction(FunctionType="DoseFallOff", RoiName="zr Perineum")
   Po.Objective.ConstituentFunctions[26].DoseFunctionParameters.HighDoseLevel = int(DosePrescription*0.69444)
   Po.Objective.ConstituentFunctions[26].DoseFunctionParameters.LowDoseLevel = int(DosePrescription*0.45)
   Po.Objective.ConstituentFunctions[26].DoseFunctionParameters.LowDoseDistance = 1.2
   Po.Objective.ConstituentFunctions[26].DoseFunctionParameters.Weight = 30
   
def create_contour_from_dose(dose, dose_level):
	roi = case.PatientModel.CreateRoi(Name=f"zr Dose_{dose_level}%", Color="Yellow", Type="Control", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
...
def add_105constrain(Name,DosePrescription):
	...
	with CompositeAction('Add optimization function'):
		AddCostFunc27 = Po.AddOptimizationFunction(FunctionType="MaxDvh", RoiName=Name)
		Po.Objective.ConstituentFunctions[27].DoseFunctionParameters.DoseLevel = int(DosePrescription*1.035)
		Po.Objective.ConstituentFunctions[27].DoseFunctionParameters.PercentVolume = 1
		Po.Objective.ConstituentFunctions[27].DoseFunctionParameters.Weight = 500
...
def Button_Next():
 try:
  ...
  try:
   ...
   if examination.Name == 'CT Replan':
    print('CT name is CT Replan already')
   else:
    examination.Name = 'CT Replan'
   get_CT_Curve()
   #Creat virtual organ : z Ant
   VirtualAnt = case.PatientModel.CreateRoi(Name="zr Ant", Color="Yellow", Type="Control",
   ...
   VirtualAnt.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Intersection", 
              'SourceRoiNames': [Opt9, "zr Ant"], 'MarginSettings': { 'Type': "Expand", 'Superior': 0, 
   ...
   VirtualRing = case.PatientModel.CreateRoi(Name="zr RingPTV", Color="White", Type="Control", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
   ...
   VirtualBladder = case.PatientModel.CreateRoi(Name="zr Bladder", Color="White", Type="Control", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
   ...
   VirtualPtv504Organ = case.PatientModel.CreateRoi(Name="zr PTV 50.4+Organ", Color="White", Type="Control", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
   ...
   VirtualPTV504 = case.PatientModel.CreateRoi(Name="zr PTV50.4", Color="SaddleBrown", Type="Control", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)  
     #Creat virtual organ : z Perineum
   VirtualPerineum = case.PatientModel.CreateRoi(Name="zr Perineum", Color="SaddleBrown", Type="Control", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
   VirtualPerineum.CreateAlgebraGeometry(Examination=examination, Algorithm="Auto", ExpressionA={ 'Operation': "Union",
            ...
            'Anterior': 0, 'Posterior': 0, 'Right': 0, 'Left': 0 })  
   #Add plan
   plan = case.AddNewPlan(PlanName = 'VMAT', ExaminationName = 'CT Replan')
   beam_set = plan.AddNewBeamSet(Name='VMAT', ExaminationName = 'CT Replan', 
   ...
   beam_set.SetDefaultDoseGrid(VoxelSize={'x': 0.2, 'y': 0.2, 'z': 0.2})
            #Isocenter placment
   Iso_StructureSet =  case.PatientModel.StructureSets['CT Replan']
   ...
   DosePrescription = float(TotalDose_Gy.get()) * 100
   for o in range(1,6):
    MinCtv504 = plan.TreatmentCourse.TotalDose.GetRelativeVolumeAtDoseValues(RoiName=Opt2, DoseValues=[int(DosePrescription)])
    ...
    if MinDvhPtv504[0] < int(DosePrescription):
     Po.Objective.ConstituentFunctions[0].DoseFunctionParameters.Weight = 300*(2**o)
    if MaxBladder[0] > int(DosePrescription)*1.035:
     Po.Objective.ConstituentFunctions[3].DoseFunctionParameters.Weight = 50+(10*(2**o))
    if MaxSigmoid[0] > int(DosePrescription)*1.035:
     Po.Objective.ConstituentFunctions[7].DoseFunctionParameters.Weight = 50+(10*(2**o))
    if MaxSmallBowel[0] > int(DosePrescription)*1.035:
     Po.Objective.ConstituentFunctions[13].DoseFunctionParameters.Weight = 50+(10*(2**o))
    ## Run optimize
    Po.RunOptimization(ScalingOfSoftMachineConstraints=None)
    
   ## Check Dose 105% area
   dose1035 = plan.TreatmentCourse.TotalDose.GetRelativeVolumeAtDoseValues(RoiName=Opt1, DoseValues=[int(DosePrescription)*1.035])
   if dose1035 > 0.05:
   	## Covert 105% to contour
   	create_contour_from_dose(plan.TreatmentCourse.TotalDose, 103.5)
   	add_105constrain("zr Dose_103.5%",DosePrescription)
